...
/* **********************************************************************************
    ...
    The custom type is "NavRadio737", which means 14 characters plus NULL = 15
...
void MFCustomDevice::attach(uint16_t adrPin, uint16_t adrType, uint16_t adrConfig, bool configFromFlash)
{
    ...
    ********************************************************************************** */
    ...
    //uint8_t _pin1, _pin2, _pin3;      //COMMENTED OUT, PRIME FOR DELETION
    ...
    ********************************************************************************** */
    ...
    if (strcmp(parameter, "NavRadio737") == 0)
    ...
    if (_customType == MY_CUSTOM_DEVICE_1) {
        ...
        ********************************************************************************** */
        if (!FitInMemory(sizeof(NavRadio737))) {
        ...
        ********************************************************************************** */
        ...
        _mydevice = new (allocateMemory(sizeof(NavRadio737))) NavRadio737();
        _mydevice->attach();
